...
namespace LoginWebApplicationMVC38.Controllers
{
    public class UsersController : Controller
    {
        private readonly Ict2inventoryManageDbContext _context;

        public UsersController(Ict2inventoryManageDbContext context)
        {
            _context = context;
        }
